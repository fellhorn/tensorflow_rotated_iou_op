...
# Additional setup to TensorFlow Custom Op guide:

create a symlink to the cuda headers in your tensorflow repo:
```
cd  ~/venvs/build-env/lib/python3.6/site-packages/tensorflow_core/include/third_party
